...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // এখানে ফর্ম সাবমিটের লজিক বা API কল যুক্ত করতে পারেন
    setIsSubmitted(true);
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-base text-slate-600">
            জরুরি সেবা, ডাক্তার অ্যাপয়েন্টমেন্ট কিংবা যেকোনো তথ্যের জন্য আমাদের সাথে যোগাযোগ করুন। আমরা ২৪ ঘণ্টা আপনার সেবায় প্রস্তুত।
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">জরুরি: ০১৯৫০-২৫৮০২৫</p>
                <p className="text-sm text-slate-600 mt-0.5">রিসেপশন: ০১৭০০-০০০০০০</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-start gap-4">
              ...
              <div>
                <h3 className="text-base font-semibold text-slate-800 mb-1">সেবার সময়</h3>
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl shadow-sm border border-slate-100 p-8 sm:p-10">
            ...
            {isSubmitted ? (
              <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-8 text-center space-y-3">
                ...
                <h3 className="text-lg font-bold text-emerald-800">বার্তা সফলভাবে পাঠানো হয়েছে!</h3>
